namespace LMS.DataAccess.Entities
{
    public class PersonEntity
    {
        ...
        public PersonEntity(uint personID, string firstName, string lastName, string? email,string phonenumber, DateTime dateOfBirth, char gender,
    ...
    {
        public MemberEntity(uint personId, uint memberId, string username, string passwordHash, string passwordSalt, DateTime joinedAt,
    ...
    public class CountryEntiry
    {
        public CountryEntiry(uint countryId, string countryName)
        {
            CountryId = countryId;
